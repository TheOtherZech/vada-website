...
<op>&lt~</op> <ref><kw>@std</kw><op>::</op><ref>util</ref><op>::</op><schema>$</schema><op>.</op><enc>[</enc><schema>$utilSchema</schema><enc>]</enc></ref>

<sect>--- <kw>@Local</kw></sect><op>:</op>
<schema>$edType</schema><op>:</op> <str>"None"</str> <op>|</op> <str>"Highschool"</str> <op>|</op> <str>"Undergraduate"</str> <op>|</op> <str>"Graduate"</str>
...
<div class="indent"><kw>@Doc</kw><op>::</op><ref>short</ref><op>:</op> <str>"A basic structure for person data"</str>

<sect>--- Basic:</sect>
<ref>name</ref><op>:</op> <schema>$desc_string</schema>
<ref>age</ref><op>:</op>  <type>!int</type> <op>&</op> <op>></op> <lit>0</lit>
<ref>address</ref><op>:</op> <kw>@Local</kw><op>::</op><schema>$addrStruct</schema> <op>|</op> <kw>@None</kw> <comment>// Words!</comment>

<sect>--- Experience</sect><op>:</op>
<ref>employer</ref><op>:</op> <enc>(</enc><type>!str</type> <op>&</op> <op>!=</op> <enc>""</enc><enc>)</enc> <op>|</op> <kw>@None</kw>
<ref>education</ref><op>:</op> <enc>[</enc><enc>(</enc><type>$edType</type>, <schema>$desc_string</schema><enc>)</enc>, ...<enc>]</enc>
<ref>certs</ref><op>:</op> <list><enc>[</enc><type>!str</type> <op>&</op> <op>!=</op> <enc>""</enc>, ...<enc>]</enc> <op>|</op> <kw>@None</kw></list>

<func>#score</func><op>:</op> <ref>certs</ref><op>-></op><func>#reduce(<kw>@sum</kw>)</func>
<div class="indent"><op>+</op> <ref>education</ref><op>-></op><func>#reduce:</func> <op>+</op> <ref><op>?</op>[_]:</ref>
